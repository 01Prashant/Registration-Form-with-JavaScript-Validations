...
function fullName(){
  ...
  if(len >= 16){
      ...
      document.getElementById('fullName').innerHTML = `It content First latter UpperCase and remaining lower case character. it will also support @ and underscore ( _ ) only. the word does not repeat more than 2 times`;
  }
}
...
const languageRegex = /^(en|hi|fr|es|de|it)$/; 
...
function fetchData() {
    ...
    const othersRadio = document.getElementById("othres");
